...
Co ciekawe praktycznie wszystkie rozwiązania dokonują dość małego krzyżowania (wymieniane jest pierwsze i ostatnie 10% genów, po za jednym wyjątkiem).

idnexterm:[Mutaja, Swap]
