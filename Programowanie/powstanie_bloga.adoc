...
- kompletny brak kontroli wdów i innych błędów typograficznych, np. opis zdjecia/tabeli/kodu potrfi być na innej stronie niż na tej co najważniejszy obraz.
- brak płynnej kontroli elementów: obrazy pojawiają się DOKŁADNIE tam gdzie wprwowadzisz je w kodzie.
