...
. Wadą tego rozwiązania jest to, że silnie polega ono na katalogu źródłowym szablonu. 
...
. Teraz usuń lub zmień nazwę katalogu źródłowego (czyli `simplest`) i spróbuj ponownie utworzyć nowy projekt (`dotnet new ztr-core`)
+
****
[source,console]
----
