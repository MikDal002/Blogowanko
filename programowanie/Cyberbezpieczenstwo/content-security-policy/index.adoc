...
. Jak upewnić się, że zebrano wszystkie zależności i adresy, które należy uwzględnić w polityce?

. Jak stosować osobne polityki dla poszczególnych środowisk (DEV, QA, PROD), tak aby nie pisać kolubryny wykluczeń?
...
Przykład takiego wykonania znajdziesz w poniższym wycinku pliku `package.json`, w linijce 5.
